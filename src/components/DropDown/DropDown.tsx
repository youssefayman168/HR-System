...
const DropDown = ({ text1, text2, text3, text4, text5, style }: Drop) => {
  ...
  return (
    <>
      <ul className='DropDownTable duration-300 w-[225px] text-start bg-white shadow-xl rounded-[10px] border-[1px] border-[#8F93AC] absolute left-0 top-[40px] z-[900] ' style={style}>
