...
const PasswordInp = ({ label, placeHolder, onChange }: Pass) => {
    ...
    <>
      <div className='mb-6'>
        <div className='flex flex-col mt-4'>
          <label htmlFor='pas' className='pb-3 text-lg font-medium'>
            {label}
          </label>
          <div className='relative'>
            <input
              ...
              id='pas'
              type='password'
              className='border border-[#BDBDBD] placeholder:text-[#737373] py-3 px-5 focus:outline-none rounded-[10px] placeholder:text-[14px] w-[600px] h-[62px]'
            ...
            <div
              ...
              className='text-[20px] cursor-pointer absolute top-[50%]  translate-y-[-50%] right-8 '
            >
              <svg
