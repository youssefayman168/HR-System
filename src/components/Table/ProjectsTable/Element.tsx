...
const Element = ({text1 , text2 , text3 , text4 , text6 , text7 , text8 , styleStaus } : MyElement) => {
  return (
    <Link className='flex items-center gap-2 py-6 text-[#9295AB] border-b-[2px] border-[#a0aaca80] ' to={`/projects/21323`}>
        ...
        <p className='w-[20%] text-[#105090] font-[600] '>{text2}</p>
        <p className='w-[18%] '>{text3}</p>
        <p className='w-[10%]  '>{text4}</p>
        <div className='w-[10%] '>
        <p style={{background: styleStaus === "In-Progress" ? "#E6EFFC" : styleStaus === "Canceled" ? "#FFE3E3" : styleStaus === "Completed" ? "#DEFFE1" : "" ,     color : styleStaus === "In-Progress" ? "#0764E6" : styleStaus === "Canceled" ? "#A00" : styleStaus === "Completed" ? "#34E045" : ""   }} className='w-[120px]  mx-auto py-[7px] px-[12px] text-center rounded-[6px]'>{text6}</p>
        </div>
