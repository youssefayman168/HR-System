                ...
                <div className="w-full mt-6">
                    <div className="bg-white rounded-2xl mb-6 p-7 h-[400px] overflow-hidden">
                        ...
                        <div className="mt-7 overflow-y-auto HideScroll h-full pb-4">
                            <PercentageLine title="Dubai Capital Project" colorCondition="done" lineWidth={100} value="100%" />
                            <PercentageLine title="Administrative capital" colorCondition="progress" lineWidth={55} value="55%" />
                            <PercentageLine title="Dubai hotel" colorCondition="canceled" lineWidth={90} value="90%" />
                            <PercentageLine title="Administrative capital" colorCondition="progress" lineWidth={55} value="55%" />
                            <PercentageLine title="Riyadh Compound" colorCondition="planning" lineWidth={98} value="98%" />
                            <PercentageLine title="Dubai hotel" colorCondition="canceled" lineWidth={90} value="90%" />
                            <PercentageLine title="Riyadh Compound" colorCondition="planning" lineWidth={98} value="98%" />
                        </div>
                    </div>
                    <div className="h-[400px] rounded-2xl flex items-center gap-6">
                        <div className="flex-1 bg-white rounded-2xl h-full overflow-hidden">
                            <HomeTable>
                                <EmployeeInfo image={testImage} employeeName="Abdelrahman Mustafa" profession="front-end developer" projects={75} subTask={57} hours={523} />
                                <EmployeeInfo image={testImage} employeeName="Yousef Ayman" profession="back-end developer" projects={75} subTask={57} hours={523} />
                                <EmployeeInfo image={testImage} employeeName="Abdelrahman Mustafa" profession="front-end developer" projects={75} subTask={57} hours={523} />
                                <EmployeeInfo image={testImage} employeeName="Yousef Ayman" profession="back-end developer" projects={75} subTask={57} hours={523} />
                                <EmployeeInfo image={testImage} employeeName="Abdelrahman Mustafa" profession="front-end developer" projects={75} subTask={57} hours={523} />
                                <EmployeeInfo image={testImage} employeeName="Yousef Ayman" profession="back-end developer" projects={75} subTask={57} hours={523} />
