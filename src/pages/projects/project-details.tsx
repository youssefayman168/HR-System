        ...
        <div className='p-5'>
          ...
          <div className='NameProjects bg-white px-20 py-10 rounded-[15px] h-[calc(100vh-240px)] overflow-y-auto HideScroll  '>
            <div className='border-b-[1px] border-[#9295AB] pb-3'>
              ...
              <NameProjects
                Name='Project Hours'
                Value={`${data?.work_hours}h`}
              />
              <NameProjects
                Name='Work Hours'
                Value={`${data?.worked_hours}h`}
              />
            ...
            <div className='CreatePhases flex items-center justify-between mt-4  '>
              <p className='text-[#101828] font-[700] text-[20px] '>
                Project Phases
              </p>
              <BtnCreate
                icon={plus}
                text='Create Phases'
                path=''
                onClick={() => createPhases(projectID)}
              />
            </div>
            <div className='Phases'>
              <div>
                {phases?.data?.map(({ id, tasks }: any) => {
                  return (
                    <Phases
                      phaseNum={id}
                      key={id}
