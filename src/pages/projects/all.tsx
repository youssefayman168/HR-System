    ...
    <BaseLayout>
      <div className='p-5'>
        <div className='flex items-center justify-between'>
          <div>
            <p className='text-[#224886] text-[25px] font-[600]'>
              Projects overview
            </p>
          </div>
          ...
          <div className='flex items-center gap-4'>
            {myProfile.data?.role == "ProjectManager" ||
        ...
        <div
          className='TableCompo HideScroll overflow-y-auto mt-8 h-[calc(100vh-268px)] rounded-[20px]'
          ref={componentRef}
        >
          <ProjectsTable />
        </div>
