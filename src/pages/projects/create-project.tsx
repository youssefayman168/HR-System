      ...
      <div className="p-5">
        ...
        <div className="CreatProject HideScroll bg-white mt-6 rounded-[20px] px-[80px] py-[50px] h-[calc(100vh-176px)] overflow-y-auto ">
          <form className=" w-[100%] " onSubmit={(e) => {
            e.preventDefault()
            postCreateProjects(data).then(() => e.currentTarget.reset())
          }}>
            ...
            <div className="mb-5 mt-7 flex items-center gap-8">
              <div className="w-full">
                ...
                <div className="Select-Container relative w-full">
                  <select 
                  id="mySelect" 
                  className="custom-select p-5 border-[1px] border-[#ccc] w-[100%] appearance-none outline-none h-[60px] rounded-[10px] " onChange={(e) => setData((prev: any) => {
                    return {
                      ...prev,
            ...
            <div className="Description flex flex-col mt-10 gap-5">
              ...
              <div>
                <DocumentUploader
                  label="Project Plan"
                  // name="plan"
                  onSelect={(file) => setData((prev: any) => {
                    return {
                      ...prev,
                      plan: file
                    }
