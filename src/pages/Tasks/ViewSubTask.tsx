          ...
          <div className='flex items-center justify-between border-b-[1px] border-[#EFF1F4] pb-10'>
            <div className='w-[500px]'>
              ...
              <p className='text-[#676E7E]  '>
                Owners have view and edit access to user management, roles and
                permission by default which cannot be changed. You have an
                option to set permissions or add other admins
              </p>
            </div>
