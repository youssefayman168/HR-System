                                    ...
                                    <div className='mt-16 mb-7'>
                                        ...
                                        <div className='pt-5 pb-2 border-b-[1px] border-[#EAECF0] flex items-center gap-32'>
                                            <div className="flex items-start flex-col mb-6">
                                                ...
                                                <p className={`relative text-[15px] font-semibold ${data?.status === 'accept' ? 'bg-[#ECFDF3]' : data?.status === 'reject' ? 'bg-[#FFF2EA]' : data?.status === 'inactive' ? 'bg-[#FFEFC4]' : ''} ${data?.status === 'accept' ? 'text-[#027A48]' : data?.status === 'reject' ? 'text-[#F15046]' : data?.status === 'inactive' ? 'text-[#D99D00]' : ''} after:absolute ${data?.status === 'accept' ? 'after:bg-[#12B76A]' : data?.status === 'reject' ? 'after:bg-[#F15046]' : data?.status === 'inactive' ? 'after:bg-[#D99D00]' : ''} left-[-5px] py-[3px] px-3 ps-5 after:w-[8px] after:h-[8px] after:rounded-full after:top-[50%] after:translate-y-[-50%] after:left-[7px] rounded-[15px] `}>{data?.status}</p>
                                            </div>
