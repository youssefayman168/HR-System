                ...
                <form action="">
                    <div className='bg-white py-6 px-12 mt-8 rounded-[15px] h-[calc(100vh-240px)] overflow-y-auto HideScroll '>
                        <div className='flex items-center justify-between mb-10'>
                            ...
                            <button type='button' className='bg-[#105090] py-2 px-8 rounded-[10px] text-white '>Import Excel Sheet</button>
                        </div>
                    ...
                    <div className='flex items-center justify-center gap-5 mt-4'>
                        <button type='button' className='text-[#224886] border-[1px] border-[#224886] py-[8px] px-9 rounded-[6px]' >Cancel</button>
