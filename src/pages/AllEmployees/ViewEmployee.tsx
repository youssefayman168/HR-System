        ...
        <div className='p-6'>
          ...
          <div className='mt-6 rounded-2xl bg-white px-8 h-[120px] flex items-center justify-between'>
            <div className='flex items-center gap-4'>
              <p className='text-blackGrayColor text-2xl font-bold'>
                {data?.name}
              </p>
            ...
            <div className='border border-grayColor rounded-lg py-[10px] px-4 text-darkBlueColor'>
              {data?.position}
            </div>
          </div>
          <div className='mt-5 w-full rounded-lg bg-white h-[calc(100vh-340px)] flex items-stretch gap-5 p-6 overflow-y-auto HideScroll'>
            <div className='w-[25%] border border-[#EFF1F4] rounded-2xl p-6 h-fit'>
              ...
              <div className='mt-8'>
                ...
                <EmployeeInfo
                  title='email'
                  value={data?.email === null ? "Not Determined" : data?.email}
                />
                <EmployeeInfo
                  title='location'
                  value={
                    data?.location === null ? "Not Determined" : data?.location
                  }
                />
                <EmployeeInfo
                  title='hired date'
            ...
            <div className='w-[25%] border border-[#EFF1F4] rounded-2xl h-fit p-6'>
              ...
              <EmployeeInfo
                title='university'
                value={
                  data?.graduation_year_from === null
                    ? ""
                    : `${data?.graduation_year_from} To ${data?.graduation_year_to}`
                }
              />
              <p className='text-blackGrayColor -mt-6 mb-8'>
                {data?.school === null ? "Not Determined" : data?.school}
              </p>
              <EmployeeInfo title='department' value={data?.department} />
              <EmployeeInfo title='company' value={data?.company} />
              <EmployeeInfo
                title='grade'
                value={data?.grade === null ? "Not Determined" : data?.grade}
              />
              <EmployeeInfo
                title='nationality'
                value={
