...
const postCreateProjects = async (action: any, data: any) => {
    ...
    return requestHelpers.postData('/project/create/', formData, { success: 'The Project Is Created Successfully', showToast: true, error: 'The Project Does not Created' }).then(action)
}
