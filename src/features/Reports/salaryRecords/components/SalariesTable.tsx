...
const SalariesTable = ({ children, departmentDropDown, positionDropDown, departmentClick, positionClick }: any) => {
    return (
        <div className="w-full bg-white rounded-[15px] h-[calc(100vh-264px)] mt-6 overflow-hidden">
            <div className="bg-primary py-7 px-6 text-white flex items-center gap-6 w-full">
                ...
                <p className="w-[15%]">Hour Price</p>
                <p className="w-[15%]">Work Hours</p>
            </div>
            {children}
        </div>
    )
