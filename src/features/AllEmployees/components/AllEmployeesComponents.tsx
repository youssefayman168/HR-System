...
const AllEmployeesComponents = ({ employeeImg, employeeName, companyName, departmentName, positionName, onViewClick, onEditClick, onDeleteClick, styleDeleteBtn }: IProps) => {
    ...
    return (
        <div className=" py-[27px] px-6 gap-6 flex items-center w-full border-b border-b-[#D9D9DB]">
            ...
            <div className="w-[30%] flex items-center gap-2">
                ...
                <button style={styleDeleteBtn} className='py-2 px-6 bg-[#F6DADA] text-[#c71025] rounded-md capitalize font-semibold' onClick={onDeleteClick}>delete</button>
            </div>
        </div>
